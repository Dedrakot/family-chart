...
export function Card(props) {
  ...
  return function ({node, d}) {
    const el = document.createElementNS("http://www.w3.org/2000/svg", 'g'),
      ...
      card_image = () => CardImage({d, image: store.methods.avatar(d), card_dim, maleIcon: null, femaleIcon: null}).template,
      ...
      divorce_icon = d.data.rels.divorces ? DivorceIconWrapper({store, d,card_dim}) : '',
